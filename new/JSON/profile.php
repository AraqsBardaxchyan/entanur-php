...
session_start();
    ...
    if(isset ($_POST['change'])){
	   ...
	   header('location: ../Login/logout.php');die; 
        }    
        }
        $error = true;
    }
...
<body>
    ...
    <div class="fluid">
        <div class="header">
            ...
            <a class="btn btn-danger " href="../Gallery/gallery.php" role="button">Galery</a>
            <div class="modal fade" id="myModal" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="mapouter">
                            <div class="gmap_canvas"><iframe width="640" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=yerevan&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.embedgooglemap.net">embedgooglemap.net</a></div>
                            <style>
                                .mapouter {
                                    position: relative;
                                    text-align: right;
